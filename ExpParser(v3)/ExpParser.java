...
k=-1;
    ...
    e1 = T();
if (k<0) e1 = new Times(new Num(k), e1);
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case PLUS:
...
{if ("" != null) return e1;}
  ...
  static final public Exp T() throws ParseException {Exp e1,e2;
    e1 = P();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return e1;}
  ...
  static final public Exp P() throws ParseException {Exp e1,e2; int k=1;
    e1 = F();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case POWER:{
...
{if ("" != null) return e1;}
  ...
  static final public Exp F() throws ParseException {Exp e; Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ID:{
...
{if ("" != null) return new Num(Integer.parseInt(t.image));}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x60,0x60,0x60,0x60,0x80,0x100,0x600,};
   }
